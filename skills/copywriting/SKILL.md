---
name: copywriting
description: "[DEPRECIE — Utiliser /cta-optimizer pour les CTAs/emails, et agent-redacteur pour le contenu des pages] Write rigorous, conversion-focused marketing copy for landing pages and emails."
risk: unknown
source: community
date_added: "2026-02-27"
---

# Copywriting [DEPRECIE]

> **Cette skill est remplacee par :**
> - `/cta-optimizer` — pour les CTAs, headlines, boutons, emails marketing
> - `agent-redacteur` — pour le contenu des pages (accueil, services, a propos, contact, blog)
>
> L'ancienne skill reste en reference mais ne doit plus etre invoquee directement.
